...
import (
	...
	"github.com/stake-plus/govcomms/src/research-bot/bot"
...
func main() {
	...
	log.Println("Research bot is running. Press CTRL-C to exit.")
	...
	b.Stop()
	log.Println("Research bot stopped gracefully")
}
